...
{
    if (!database)
       throw Base::RuntimeError("getPropertyId: Source not added to a database.");
...
{
    if (!database)
       throw Base::RuntimeError("getPropertyName: Source not added to a database.");
...
{
    if (!database)
       throw Base::RuntimeError("getNumProperties: Source not added to a database.");
...
{
    if (!database)
       throw Base::RuntimeError("createMaterial: Source not added to a database.");

    if (isReadOnly())
        throw Base::RuntimeError("Unable to create material; material source is read-only.");
...
{
    if (!database)
       throw Base::RuntimeError("getMaterial: Source not added to a database.");
...
{
    if (!database)
       throw Base::RuntimeError("getMaterials: Source not added to a database.");
...
{
    if (!database)
       throw Base::RuntimeError("toPyObject: Source not added to a database.");
...
{
    if (!database)
       throw Base::RuntimeError("fromPyObject: Source not added to a database.");
...
{
    if (!database)
       throw Base::RuntimeError("toString: Source not added to a database.");
...
{
    if (!database)
       throw Base::RuntimeError("fromString: Source not added to a database.");
...
Py::Object Py::MaterialSourcePy::removeMaterial(const Py::Tuple &)
{
