...
ViewProviderPartExt::ViewProviderPartExt() 
{
    ...
    // Get default material so we have something; it will be overridden in the onChanged method when we have a change in an actual object
    ...
    ADD_PROPERTY_TYPE(LineColor, (mat->getDiffuseColor()), osgroup, App::Prop_None, "Set object line color.");
    ADD_PROPERTY_TYPE(PointColor, (mat->getDiffuseColor()), osgroup, App::Prop_None, "Set object point color");
...
ViewProviderPartExt::~ViewProviderPartExt()
{
    ...
    LineColor.setValue(lmat->getDiffuseColor());
    PointColor.setValue(pmat->getDiffuseColor());
...
void ViewProviderPartExt::attach(App::DocumentObject *pcFeat)
{
    ...
    r = ((lcol >> 24) & 0xff) / 255.0;
    g = ((lcol >> 16) & 0xff) / 255.0;
    b = ((lcol >> 8) & 0xff) / 255.0;
